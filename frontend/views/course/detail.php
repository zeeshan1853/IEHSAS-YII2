                ...
                <li>
                    <div class="w3layouts-banner-top">
                        <div class="agileits-banner-info">
                            <h3> <span><?= isset($course->name) ? $course->name : 'course Name' ?></span></h3>
                        </div>	
    ...
    <div id="horizontalTab">
        ...
        <div class="resp-tabs-container">
                ...
                <div class="reset">
                    <div>
                        <table class="table">
                            <tr>
                                <th> Duration </th> 
                                <td> <?= isset($course->duration) ? $course->duration : '' ?> </td> 
                            </tr>
                            <tr>
                                <th> Fee </th> 
                                <td> <?= isset($course->fee) ? $course->fee : '' ?> </td> 
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="tab2">
                <div class="register">
                    <h6>Course Detail</h6>
                    <p><?= isset($course->detail) ? $course->detail : '' ?></p>
                </div>
            </div>
            <div class="tab3">
